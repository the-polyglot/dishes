...
namespace Dishes.API.Migrations
{
    ...
    [Migration("20230910145927_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dishes.API.Entities.Dish", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dishes.API.Entities.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DishIngredient", b =>
                {
                    b.HasOne("Dishes.API.Entities.Dish", null)
                        .WithMany()
                        .HasForeignKey("DishesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dishes.API.Entities.Ingredient", null)
                        .WithMany()
